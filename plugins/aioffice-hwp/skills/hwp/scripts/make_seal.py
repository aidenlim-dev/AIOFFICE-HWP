...
transparent PNG (e.g. macOS Preview > Markup > Signature) — see SKILL.md.
  ...
  python3 make_seal.py --text "홍길동인" --out ~/.aioffice-hwp/seal.png
...
def _require_pil():
    try:
        ...
        print("error: Pillow가 필요합니다 — 설치: pip3 install Pillow", file=sys.stderr)
        sys.exit(1)
...
def find_font(size, bold=True):
    ...
    candidates = [
        ...
        # Windows Korean fonts (bold first).
